...
// PythonObjectProperty &PythonObjectProperty::operator=(const PythonObjectProperty::ValueType &right) {
...
//  */
// std::string PythonObjectProperty::value() const { return Kernel::toString(m_value); }

// /**
//  *  @return The value of the property as a pretty string. Simply returns the value()
//  */
// std::string PythonObjectProperty::valueAsPrettyStr(const size_t /*maxLength*/, const bool /*collapseLists*/) const {
//   return value();
// }
 ...
 * function
 */
// Json::Value PythonObjectProperty::valueAsJson() const {
//   throw NotImplementedError("PythonObjectProperty::valueAsJson()");
// }
